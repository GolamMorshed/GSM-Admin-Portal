...
class SubBrandDetailsController extends Controller
{
    ...
    {
        $sub_brand_details = SubBrandDetails::join('brands','brands.id','=','sub_brand_details.brand_name')
        ->join('new_shops','new_shops.id','=','sub_brand_details.shop_name')
        ->join('merchants','merchants.id','=','sub_brand_details.merchant')
        ->join('malls','malls.id','=','sub_brand_details.mall')
        ->get([
            'sub_brand_details.id',
            'sub_brand_details.GUID',
            'sub_brand_details.sub_brand_name',
            'sub_brand_details.image',
            'sub_brand_details.image1',
            'sub_brand_details.image2',
            'sub_brand_details.image3',
            'sub_brand_details.image4',
            'sub_brand_details.video',
            'sub_brand_details.sub_brand_name',
            'brands.brand',
            'sub_brand_details.product_type',
            'new_shops.shop_name',
            'merchants.merchant_name',
            'malls.mall_name',
            'sub_brand_details.stock',
            'sub_brand_details.commission',
            'sub_brand_details.sst',
            'sub_brand_details.gst',
            'sub_brand_details.price',
            'sub_brand_details.discount_price',
            'sub_brand_details.description',
            'sub_brand_details.uom',
            'sub_brand_details.height',
            'sub_brand_details.weight',
            'sub_brand_details.fragile',
            'sub_brand_details.shipping',
            'sub_brand_details.activation',
            'sub_brand_details.admin_approval',
            'sub_brand_details.created_at',
            'sub_brand_details.updated_at'
        ]);
