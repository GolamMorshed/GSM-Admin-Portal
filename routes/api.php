...
Route::get('/single_floor/{id}',[FloorController::class,'show']);
...
Route::put('/update_sub_brand_variation/{id}',[SubBrandVariationController::class,'update']);
Route::delete('/delete_sub_brand_variation/{id}',[SubBrandVariationController::class,'destroy']);
...
Route::put('/update_sub_brand_detail_variation/{id}',[SubBrandDetailVariationController::class,'update']);
Route::delete('/delete_sub_brand_detail_variation/{id}',[SubBrandDetailVariationController::class,'destroy']);
...
// CART
Route::get('/carts/{user_GUID}',[CartController::class,'show']);
Route::post('/create_cart',[CartController::class,'store']);
Route::put('/update_cart/{id}',[CartController::class,'update']);
Route::delete('/delete_cart/{id}',[CartController::class,'destroy']);

// MY FAVORITES
Route::get('/my_favorites/{user_GUID}',[MyFavoriteController::class,'show']);
Route::post('/create_my_favorities',[MyFavoriteController::class,'store']);
Route::delete('/delete_my_favorites/{id}',[MyFavoriteController::class,'destroy']);

//MY PROFILE
Route::get('/my_profile/{user_id}',[MyProfileController::class,'show']);
Route::put('/update_my_profile/{user_id}',[MyProfileController::class,'update']);

//ORDER LIST FOR USER
Route::get('/order_list/{user_GUID}',[OrderController::class,'show']);

//ORDER LIST FOR MERCHANT
Route::get('/order_list/{merchant_GUID}',[OrderController::class,'show']);
